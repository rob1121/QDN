...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "<div class=\"nav__list\"><li :class=\"isActive('/')\"><a href=\"/\"><div class=\"menu__container logo\">QDN</div></a></li><li :class=\"isActive(home)\"><a :href=\"home\"><div class=\"menu__container\"> home</div></a></li><li :class=\"isActive(issue_qdn)\"><a :href=\"issue_qdn\"><div class=\"menu__container\"> Issue qdn</div></a></li><li v-if=\"user\"><img :src=\"env_server + '/uploads/avatar/' + user.avatar\" alt=\"profile\" class=\"profile__photo\"/>{{ user.employee.name }} &nbsp;<i class=\"fa fa-caret-up\"></i><ul class=\"dropdown\"><li v-if=\"user.access_level == 'admin'\"><a :href=\"dashboard\"><div class=\"link\">Dashboard &nbsp;<i class=\"fa fa-table dropdown__icon\"></i></div></a></li><li><a :href=\"profile\"><div class=\"link\">Profile &nbsp;<i class=\"fa fa-user dropdown__icon\"></i></div></a></li><li><a href=\"{{ env_server + '/logout' }}\"><div class=\"link\">Logout &nbsp;<i class=\"fa fa-sign-out dropdown__icon\"></i></div></a></li></ul></li></div>"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.dispose(function () {
    __vueify_insert__.cache[".menu__container.logo {\n  font-weight: bold;\n}\nli {\n  list-style: none;\n}\n.nav__list {\n  position: fixed;\n  z-index: 1;\n  top: 0;\n  margin: 0;\n  padding: 0 90px;\n  color: #fff;\n  display: inline-block;\n  background: #600;\n  width: 100%;\n  min-width: 700px;\n  box-shadow: 0 2px 2px 0 rgba(0,0,0,0.5);\n}\n.nav__list>li {\n  float: left;\n  text-transform: uppercase;\n  color: #ccc;\n  text-align: center;\n  -webkit-transition: 0.3s ease-in-out;\n  transition: 0.3s ease-in-out;\n}\n.nav__list>li .menu__container {\n  padding: 10px 20px;\n}\n.nav__list>li:hover {\n  background: #7a0000;\n  color: #fff;\n}\n.nav__list>li:first-child {\n  float: left;\n}\n.nav__list>li:last-child {\n  float: right;\n  position: relative;\n  padding: 5px;\n  cursor: pointer;\n}\n.nav__list>li:last-child .profile__photo {\n  width: 30px;\n  height: 30px;\n  border-radius: 50%;\n  border: 1px solid #fff;\n  margin-right: 10px;\n}\n.nav__list>li:last-child i.fa.fa-caret-up {\n  -webkit-transition: 0.1s ease-in-out;\n  transition: 0.1s ease-in-out;\n}\n.nav__list>li:last-child:hover .dropdown {\n  display: block;\n}\n.nav__list>li:last-child:hover i.fa.fa-caret-up {\n  -webkit-transform: rotate(-180deg);\n          transform: rotate(-180deg);\n}\n.nav__list a {\n  text-decoration: none;\n  text-align: center;\n  color: #ccc;\n  -webkit-transition: 0.3s ease-in-out;\n  transition: 0.3s ease-in-out;\n  display: inline-block;\n}\n.nav__list a:hover {\n  color: #fff;\n}\n.dropdown {\n  width: auto;\n  box-shadow: 0 2px 2px 0 rgba(0,0,0,0.5);\n  -webkit-transition: 0.1s ease-in-out;\n  transition: 0.1s ease-in-out;\n  display: none;\n  padding: 0;\n  padding-top: 5px;\n  position: absolute;\n  top: 40px;\n  left: 0;\n  right: 0;\n  background: #fff;\n  color: #000;\n  overflow: hidden;\n}\n.dropdown li {\n  padding-top: 5px;\n  padding-bottom: 5px;\n  padding-right: 10px;\n  padding-left: 5px;\n  text-align: left;\n  position: relative;\n  -webkit-transition: 0.1s ease-in-out;\n  transition: 0.1s ease-in-out;\n}\n.dropdown li a {\n  text-align: left;\n  width: 100%;\n  color: #000;\n}\n.dropdown li .dropdown__icon {\n  opacity: 0;\n  -webkit-transition: 0.3s ease-in-out;\n  transition: 0.3s ease-in-out;\n}\n.dropdown li:hover {\n  background-color: #ffd6d6;\n}\n.dropdown li:hover a {\n  display: inline-block;\n  margin-left: 5px;\n  color: #333;\n}\n.dropdown li:hover .dropdown__icon {\n  opacity: 1;\n}\n.active-link {\n  background: #7a0000;\n}\n.active-link a {\n  color: #fff;\n}\n"] = false
    document.head.removeChild(__vueify_style__)
  })
  if (!module.hot.data) {
    hotAPI.createRecord("_v-285a4491", module.exports)
  } else {
    hotAPI.update("_v-285a4491", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
},{"./components/navigationbar.vue":5,"vue":3}]},{},[6]);

//# sourceMappingURL=vue-navigationbar.js.map
