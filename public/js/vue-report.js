...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"content\">\n\n    <div class=\"group-content\">\n        <div class=\"title\">{{ title }}</div>\n\n        <div class=\"label-collection\" transition=\"slide\" v-if=\"actions.length\">\n                <label class=\"label-set what\">What</label>\n\n                <label class=\"label-set\">who</label>\n\n                <label class=\"label-set\">when</label>\n        </div>\n\n        <div v-for=\"action in actions\" transition=\"slide\" class=\"input-collection\">\n            <div class=\"input-set what\">\n                <input type=\"text\" class=\"what\" name=\"{{ names.whatname }}[]\" v-model=\"action.what\" placeholder=\"what\">\n            </div>\n\n            <div class=\"input-set\">\n                <input type=\"text\" class=\"who\" name=\"{{ names.whoname }}[]\" v-model=\"action.who\" placeholder=\"who\">\n            </div>\n\n            <div class=\"input-set\">\n                <input type=\"text\" class=\"when\" name=\"{{ names.whenname }}[]\" v-model=\"action.when\" placeholder=\"when\">\n            </div>\n\n            <a href=\"#\" @click.prevent=\"removeAction(action)\">\n                <i class=\"fa fa-close remove-btn\"></i>\n            </a>\n        </div>\n\n        <button class=\"add-btn\" @click=\"addAction\" v-show=\"actions.length < 5\" transition=\"slide\"> Add new <i class=\"fa fa-plus\"></i>\n        </button>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7b225a77", module.exports)
  } else {
    hotAPI.update("_v-7b225a77", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
	props: ['radios', 'radio_value']
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"content\">\n\t<div class=\"radios\">\n\t\t<label v-for=\"radio in radios\" class=\"radio-label\">\n\t\t\t<input type=\"radio\" name=\"radios\" v-model=\"radio_value\" :value=\"radio\">\n\t\t\t{{ radio | capitalize }}\n\t\t</label>\n\t</div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-10608320", module.exports)
  } else {
    hotAPI.update("_v-10608320", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var _section = require('./components/section.vue');

var _section2 = _interopRequireDefault(_section);

var _setOfCheckbox = require('./components/set-of-checkbox.vue');

var _setOfCheckbox2 = _interopRequireDefault(_setOfCheckbox);
...
new _vue2.default({
    ...
    data: {
        ...
        cod_radios: ['production', 'process', 'maintenance', 'facilities', 'quality assurance', 'others'],

        dispo_radios: ['use as is', 'NCMR #', 'rework', 'split lot', 'shutdown', 'shipback'],
...
//# sourceMappingURL=vue-report.js.map
