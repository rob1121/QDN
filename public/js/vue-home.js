...
exports.default = {
	...
	filters: {
		diffFromNow: function diffFromNow(date) {
	...
	methods: {
		filterQdnByStatus: function filterQdnByStatus(status) {
			var _this = this;

			this.isLoading = true;
			if (this.toRefresh(status)) {
				this.$http.get("/status?status=" + status.toLowerCase()).then(function (response) {
					_this.baseTable = response.data;
					_this.status = status;
		...
		toRefresh: function toRefresh(status) {
			return !(status == this.status && this.isShow == true);
		},
		toggleTable: function toggleTable(status) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  module.hot.dispose(function () {
    __vueify_insert__.cache["#link {\n  margin-bottom: 32px;\n}\n#link div {\n  margin: 0px;\n  padding: 0px;\n}\n#link .row {\n  margin-top: 5px;\n  margin-left: 5px;\n  margin-row: 5px;\n}\n.modal-body {\n  padding-top: 0px;\n  padding-bottom: 0px;\n}\n.table {\n  background-color: #fff;\n  margin-bottom: 0px;\n  padding-top: 0px;\n  padding-bottom: 0px;\n}\n.panel-primary>.panel-heading {\n  background-color: #800;\n}\n.panel {\n  border: 0px;\n}\n.panel .panel-primary,\n.panel .panel-body,\n.panel .panel-heading,\n.panel .panel-footer {\n  border-radius: 0px;\n  border: 0px;\n}\n.well {\n  margin: 0 auto;\n  box-shadow: 0 3px 5px 0px rgba(0,0,0,0.5);\n  background-color: #fff;\n  border: 1px solid #e3e3e3;\n  border-radius: 0px;\n}\nposition: relative,\nz-index: 1,\n.loader,\nposition: absolute,\nz-index: 2,\ntop: 0 {\n  bottom: 0;\n  left: 0;\n  right: 0;\n  display: block;\n  background-color: #222;\n}\n.box {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-line-pack: center;\n      align-content: center;\n  -webkit-box-orient: horizontal;\n  -webkit-box-direction: normal;\n      -ms-flex-direction: row;\n          flex-direction: row;\n  -webkit-box-pack: justify;\n      -ms-flex-pack: justify;\n          justify-content: space-between;\n  -ms-flex-wrap: wrap;\n      flex-wrap: wrap;\n}\n.box .panel {\n  min-width: 250px;\n  box-shadow: 0 3px 5px 0px rgba(0,0,0,0.5);\n}\n.box a {\n  text-decoration: none;\n}\n.box i.fa.fa-arrow-circle-right {\n  float: right;\n}\ntr {\n  font-size: 14px;\n}\ntr >th {\n  font-weight: bold;\n}\ntr .row-empty {\n  text-align: center;\n}\ntr li {\n  list-style: none;\n}\n"] = false
    document.head.removeChild(__vueify_style__)
  })
  if (!module.hot.data) {
    hotAPI.createRecord("_v-2f18d69a", module.exports)
  } else {
    hotAPI.update("_v-2f18d69a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"moment":1,"vue":6,"vue-hot-reload-api":3,"vue-spinner/dist/vue-spinner.min.js":5,"vueify/lib/insert-css":7}],9:[function(require,module,exports){
"use strict";
...
var _qdnCollapse = require("./components/qdnCollapse.vue");

var _qdnCollapse2 = _interopRequireDefault(_qdnCollapse);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_vue2.default.use(require('vue-resource'));

_vue2.default.http.headers.common['X-CSRF-TOKEN'] = document.querySelector('#_token').getAttribute('content');
...
//# sourceMappingURL=vue-home.js.map
