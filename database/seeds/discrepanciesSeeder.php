...
class discrepanciesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        ['LABEL SWAPPING', 'category' => 'LABEL ISSUE', 'is_major' => 'true', 'with_lot_involved' => 'true'],
        ['WRONG LABEL', 'category' => 'LABEL ISSUE', 'is_major' => 'true', 'with_lot_involved' => 'true'],
        ['OTHER LABEL RELATED ISSUE', 'category' => 'LABEL ISSUE', 'is_major' => 'true', 'with_lot_involved' => 'true'],
        ...
        ['name' => 'SOP VIOLATION', 'category' => '', 'is_major' => 'true', 'with_lot_involved' => 'true'],
        ['name' => 'KDTM VIOLATION', 'category' => '', 'is_major' => 'true', 'with_lot_involved' => 'true'],
        ['name' => 'OTHERS', 'category' => '', 'is_major' => 'true', 'with_lot_involved' => 'true'],
    ])->map(function($disc){
            Discrepancy::create([
                'name'  => $disc['name'],
